...
public class Database {
   ...
   static Logger log = Logger.getLogger(Database.class);
    ...
    public Database(String db, String driver) throws IOException, ClassNotFoundException, SQLException {
        url=configProperties.MySQL_DB();
        log.info(url);
        // Load driver for JDBC class
        Class.forName(configProperties.MySQL());
                
        // Create a connection to the database
        String user_name=configProperties.MySQL_DB_USER();
        String user_pass=configProperties.MySQL_DB_PASSWORD();
